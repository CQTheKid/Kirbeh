...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.animation.addByPrefix('bump', 'Kirby logo bumpin', 24, false);
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('Ricki'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if (!closedState)
		{
			...
			{
				case 1:
					createCoolText(['Kirbeh!'], 15);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Programmed- CQ', 15);
					addMoreText('Art- Marquis Artuis', 15);
					addMoreText('Music- Zomboi', 15);
					addMoreText('Charting- Jelly', 15);
				...
				// credTextShit.screenCenter();
				case 7:
					createCoolText(['Rest Well'], -40);

				case 8:
					addMoreText('Ricki', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 12:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 18:
					addMoreText('KIRBEH!'); // credTextShit.text += '\nFunkin';
