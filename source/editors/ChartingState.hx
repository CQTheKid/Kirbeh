...
class ChartingState extends MusicBeatState
{
	...
	var eventStuff:Array<Dynamic> = [
		...
		['Know My Power', "Triggers Meta-Knight to use his giant slash Attack"]
	];
	...
	**/
	...
	function loadSong():Void
	{
		...
		var file:Dynamic = Paths.playerVoices(currentSongName);
		vocals = new FlxSound();
	...
	function loadAudioBuffer()
	{
		...
		{
		#end
			var leOpponentVocals:String = Paths.getPath(currentSongName + '/Voices.' + Paths.SOUND_EXT, SOUND, 'songs');
			if (OpenFlAssets.exists(leOpponentVocals))
			{ // Vanilla voices
				audioBuffers[1] = AudioBuffer.fromFile('./' + leOpponentVocals.substr(6));
			}
			var lePlayerVocals:String = Paths.getPath(currentSongName + 'player/Voices.' + Paths.SOUND_EXT, SOUND, 'songs');
			if (OpenFlAssets.exists(lePlayerVocals))
			{ // Vanilla voices
				audioBuffers[1] = AudioBuffer.fromFile('./' + lePlayerVocals.substr(6));
