...
class Paths
{
	...
	{
		var CHARA_PREF:String = PlayState.instance.boyfriend.curCharacter;

		if (CHARA_PREF == null)
		{
			CHARA_PREF = DEFAULT_CHARACTER;
		}

		var songKey:String = '${song.toLowerCase().replace(' ', '-')}/player/$CHARA_PREF';

		trace(songKey);
		var path:String = getPath('song/$songKey.$SOUND_EXT', SOUND, null);
