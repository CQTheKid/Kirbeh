...
class FreeplayState extends MusicBeatState
{
	...
	private static var opponentVocals:FlxSound = null;
	private static var playerVocals:FlxSound = null;
	...
	{
		if (opponentVocals != null || playerVocals != null)
		{
			opponentVocals.stop();
